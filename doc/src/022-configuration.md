...
Here is a full configuration file, documented by its annotation :
...
# For CI, we do not need the full fasta during benchmarking. To avoid duplicating the FASTA and
# running out-of-memory, use a smaller reference 
