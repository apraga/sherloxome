...
```bash
nextflow run  nf-core/sarek --input samplesheet-agilent.csv -r 3.7.1 --outdir data/exp_raw/giab --tools haplotypecaller --skip_tools haplotypecaller_filter --wes --intervals data/ref/capture/Agilent_SureSelect_All_Exons_v7_hg38_Regions.bed -profile apptainer
```
